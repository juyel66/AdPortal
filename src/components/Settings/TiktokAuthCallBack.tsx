...
interface TikTokAdAccountsResponse {
  data: TikTokAdAccount[];
}
...
const TiktokAuthCallBack = () => {
  ...
  const [selectedAccount, setSelectedAccount] = useState<TikTokAdAccount | null>(null);
  ...
  const fetchAdAccounts = async () => {
    try {
      ...
      const response = await api.get<TikTokAdAccountsResponse>(`/main/get-ad-profiles`, {
        params: {
          platform: "TIKTOK",
          org_id: org_id,
        },
      ...
      setError(err.response?.data?.message || "Failed to fetch TikTok ad accounts");
      console.error(err);
    } finally {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.message || "Failed to save TikTok account");
      console.error(err);
    } finally {
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 max-w-md w-full">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mb-4">
              TikTok account connected successfully. Redirecting to dashboard...
            </p>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            >
              <path
                d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25 4.83 4.83 0 0 1-3.77 4.25 4.83 4.83 0 0 1 3.77 4.25 4.83 4.83 0 0 1 3.77-4.25z"
                fill="#010101"
              />
              <path
                d="M16.72 2.44a5.23 5.23 0 0 0-4.41 4.67 5.23 5.23 0 0 0 4.41 4.67 5.23 5.23 0 0 0-4.41-4.67 5.23 5.23 0 0 0 4.41-4.67z"
                fill="#25F4EE"
              />
              <path
                d="M4.5 9.5a4.5 4.5 0 0 1 4.5 4.5 4.5 4.5 0 0 1-4.5-4.5z"
                fill="#FE2C55"
              />
            </svg>
          ...
          <p className="text-sm text-gray-500 ml-11">
            Select your TikTok ad account to connect
          </p>
        </div>
          ...
          {loading.accounts ? (
            ...
            <div className="border border-gray-200 rounded-lg p-8 text-center">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Make sure you have a TikTok Business account with ads access
              </p>
            </div>
          ) : (
        ...
        {selectedAccount && !loading.saving && !loading.accounts && (
          <div className="mt-4 text-right text-xs text-gray-500 space-y-0.5">
            <div>Selected Account: {selectedAccount.advertiser_name}</div>
